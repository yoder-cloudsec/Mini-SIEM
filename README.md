...
mini-siem/
│
├── collector.py      # Simulates logs and sends them to Elasticsearch
...
Configuration
Elasticsearch URL, credentials, and index are configured in collector.py and detector.py:
...
Inspired by basic SIEM workflows for learning and experimentation
